...
private extension MainTabbarFlow{
    func coordinateToMainTabbar() -> FlowContributors {
        Flows.use(
            ...
            let matchImage = UIImage.init(systemName: "sportscourt.fill")
            let newsImage = UIImage.init(systemName: "newspaper.fill")
            let leagueImage = UIImage.init(systemName: "trophy.fill")
            
            let matchSelectedImage = UIImage.init(systemName: "sportscourt.fill")
            let newsSelectedImage = UIImage.init(systemName: "newspaper.fill")
            let leagueSelectedImage = UIImage.init(systemName: "trophy.fill")
